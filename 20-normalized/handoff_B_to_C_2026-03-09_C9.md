...
- **matrix:** `30-analysis/cross/challenge_matrix_2026-03-09_C9.csv`
- **log:** `30-analysis/cross/challenge_log_2026-03-09_C9.md`
...
1. **落实 C9-A20 的闭环（证据：C7/C8/C9 挑战矩阵）**  
   - 在 `40-insights/risks/`（如 upgrade-risk-matrix.csv 或 failure-patterns 相关资产）中新增或修订一条：**“临时例外须含自动化到期检查与升级路径；不得仅依赖人工到期”**，并注明依据为 C7-B-016、C8-A07、C9-A20 的 B 审校结论。  
