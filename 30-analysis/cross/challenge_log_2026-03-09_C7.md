...
- input_scope:
  - `40-insights/risks/upgrade-risk-matrix.md` / `upgrade-risk-matrix.csv`
  - `40-insights/risks/upgrade-risk-rollout-plan.md`
  - `30-analysis/cross/w9_upgrade_radar.md`
  - `30-analysis/cross/architecture-decision-benchmark.md`
  - `40-insights/risks/failure-patterns.md`
- output_matrix: `30-analysis/cross/challenge_matrix_2026-03-09_C7.csv`
