...
- matrix: `analysis/cross/challenge_matrix_2026-03-09_C2.csv`
- log: `analysis/cross/challenge_log_2026-03-09_C2.md`
...
## Required C Edits
1. 在 `data/master/repo_master.csv` 增加字段：
   - `adoption_profile` (`minimal` / `scale`)
   - `trigger_threshold`
   - `exception_policy`
2. 在 `insights/adoption_backlog.md`：
   - 每条建议增加“不成立条件”与“回滚信号”。
3. 在风险文件补充：
