...
- **input_scope:**
  - `sources/scans/scan_2026-03-09_A_C8.md`
  - `sources/scans/evidence_2026-03-09_A_C8.csv`
  - `sources/scans/handoff_A_to_B_2026-03-09_C8.md`
- **output_matrix:** `analysis/cross/challenge_matrix_2026-03-09_C8.csv`
...
### C8-A12 — fails
**Claim:** Crawl/Search 栈选型与分类由 analysis/crawl 文档与 CSV 归纳。  
**Challenge:** 选型与分类仅依赖内部归纳，无外部采纳案例或 star/issue 趋势；采纳信号不可仅据此决策。  
**Counter source:** ../../analysis/crawl/llm_web_crawl_search_2026-03-09.md  
...
- **C8-A12:** Crawl/Search 栈选型与分类由 analysis/crawl 文档与 CSV 归纳。  
...
1. **C8-A12 (fails):** 采纳信号不可仅依 analysis/crawl 内部归纳；补充外部来源或标注「待外部验证」。  
