...
- **Inputs consumed**:
  - A: `sources/scans/scan_2026-03-09_A_C9.md`, `evidence_2026-03-09_A_C9.csv`, `handoff_A_to_B_2026-03-09_C9.md`
  - B: `analysis/cross/challenge_log_2026-03-09_C9.md`, `challenge_matrix_2026-03-09_C9.csv`, `99-archive/handoffs/handoff_B_to_C_2026-03-09_C9.md`
...
- **data/risks/upgrade-risk-matrix.csv**: (1) 修订 cross-stack/temporary-exception-policy，明确「临时例外须含自动化到期检查与升级路径，不得仅依赖人工到期」，依据 C7-B-016、C8-A07、C9-A20；(2) 新增 cross-stack/C9-gateway-cascade-runbook：网关/路由级联故障需写入 runbook 与演练（C9-A08）。
- **insights/adoption_backlog.md**: 增加 C9 决策原则、C9-A20 拒绝及 B top 5 闭环说明；六轨结论保持 adoption_profile / trigger 标注。
- **publish/digests/weekly_digest_2026-03-09_C9.md**（本文件）、**index/CHANGELOG.md**、**index/CYCLE_SCOREBOARD.csv**：C9 行已追加。
...
- `publish/digests/weekly_digest_2026-03-09_C9.md`
- `index/CHANGELOG.md`
