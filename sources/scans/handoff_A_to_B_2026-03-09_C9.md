...
- 已写 **`sources/scans/C8_unknown5_crawl_coverage_preview.md`**：ForgeCrawl（无公开 issue）、RagRabbit（1 issue）、Crawl2RAG（已归档）预扫与下轮纳入建议、P2 映射建议。不占 C9 claim 配额，供 C10 或 B 参考。

## Evidence and Scan References

- Evidence file: `sources/scans/evidence_2026-03-09_A_C9.csv`
- Scan file: `sources/scans/scan_2026-03-09_A_C9.md`
- C8 未知 #5 预扫: `sources/scans/C8_unknown5_crawl_coverage_preview.md`
